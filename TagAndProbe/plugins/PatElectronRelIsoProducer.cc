...
void PatElectronRelIsoProducer::produce(edm::Event & iEvent, const edm::EventSetup & iSetup) {
  ...
  for(unsigned iele=0; iele<nele; ++iele) {
    ...
    if (isMC_) {
      ...
      AEff03 = ElectronEffectiveArea::GetElectronEffectiveArea(ElectronEffectiveArea::kEleGammaAndNeutralHadronIso03, fabs(gsfel->superCluster()->eta()), ElectronEffectiveArea::kEleEAData2011);      
    }
