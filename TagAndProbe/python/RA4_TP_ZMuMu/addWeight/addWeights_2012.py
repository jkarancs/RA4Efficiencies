...
dirMC = [
    "../Mu_120928/MC/DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball/",
    "../Mu_120928/MC/QCD_HT-250To500_TuneZ2star_8TeV-madgraph-pythia6/",
    "../Mu_120928/MC/QCD_HT-500To1000_TuneZ2star_8TeV-madgraph-pythia6/",
    "../Mu_120928/MC/QCD_HT-1000ToInf_TuneZ2star_8TeV-madgraph-pythia6/",
    "../Mu_120928/MC/TTJets_MassiveBinDECAY_TuneZ2star_8TeV-madgraph-tauola/",
    "../Mu_120928/MC/T_s-channel_TuneZ2star_8TeV-powheg-tauola/",
    "../Mu_120928/MC/T_t-channel_TuneZ2star_8TeV-powheg-tauola/",
    "../Mu_120928/MC/T_tW-channel-DR_TuneZ2star_8TeV-powheg-tauola/",
    "../Mu_120928/MC/Tbar_s-channel_TuneZ2star_8TeV-powheg-tauola/",
    "../Mu_120928/MC/Tbar_t-channel_TuneZ2star_8TeV-powheg-tauola/",
    "../Mu_120928/MC/Tbar_tW-channel-DR_TuneZ2star_8TeV-powheg-tauola/",
    #"../Mu_120928/MC/WJetsToLNu_HT-250To300_8TeV-madgraph/",
    #"../Mu_120928/MC/WJetsToLNu_HT-300To400_8TeV-madgraph/",
    #"../Mu_120928/MC/WJetsToLNu_HT-400ToInf_8TeV-madgraph/",
    "../Mu_120928/MC/WJetsToLNu_TuneZ2Star_8TeV-madgraph-tarball/",
    "../Mu_120928/MC/WW_TuneZ2star_8TeV_pythia6_tauola/",
    "../Mu_120928/MC/WZ_TuneZ2star_8TeV_pythia6_tauola/",
    "../Mu_120928/MC/ZZ_TuneZ2star_8TeV_pythia6_tauola/"
]

dirData = [
    #"../Mu_120928/Data/MuHad_Run2012A-13Jul2012-v1/",
    #"../Mu_120928/Data/MuHad_Run2012B-13Jul2012-v1/",
    #"../Mu_120928/Data/MuHad_Run2012C-PromptReco-v1/",
    #"../Mu_120928/Data/MuHad_Run2012C-PromptReco-v2/",
    "../Mu_120928/Data/SingleMu_Run2012A-13Jul2012-v1/",
    "../Mu_120928/Data/SingleMu_Run2012B-13Jul2012-v1/",
    "../Mu_120928/Data/SingleMu_Run2012C-PromptReco-v1/",
    "../Mu_120928/Data/SingleMu_Run2012C-PromptReco-v2/"
]
...
mcNames = [
    ...
    "Tbar_t",
    "Tbar_tW",
    #"WJetsToLNu_HT-250To300",
    #"WJetsToLNu_HT-300To400",
    #"WJetsToLNu_HT-400ToInf",
    "WJetsToLNu",
    "WW",
    "WZ",
    "ZZ"
...
lumi = 1000.
dataDir = "fitHltFromGlb"
useTree = "fitter_tree"

vtxLeaf = "tag_nVertices"
massLeaf = "mass"
combIsoLeaf = "reliso"
common_cut = "(pt > 10 && abs(eta) < 2.4 && " + vtxLeaf + " <= " + str(max_vtx) + " && " + vtxLeaf + " > 0 " + " && " + massLeaf + " > " + str(min_mass) + " && " + massLeaf + " < " + str(max_mass) + ")"
...
for (i,dir) in enumerate(dirMC):
    ...
    for file in filenames:
        ...
        if (file.partition("_")[0] != "tpZMuMu" and file.partition("_")[2].partition("_")[0] != "MC.root"): continue 
