...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /RA4Efficiencies/TagAndProbe/python/RA4_TP_ZMuMu/runTnP_MC.py,v $'),
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("tpZMuMu_MC.root"))
